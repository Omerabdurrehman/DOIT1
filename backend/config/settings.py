...
Backend: Django + Django REST Framework + SQLite/PostgreSQL support for local and Render deployments.
"""
import os
...
ALLOWED_HOSTS.extend([host for host in os.getenv("ALLOWED_HOSTS", "").split(",") if host])
...
# ---------------------------------------------------------------------------
# Database configuration for local development and Render deployment.
# ---------------------------------------------------------------------------
