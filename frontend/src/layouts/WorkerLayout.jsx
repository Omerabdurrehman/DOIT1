    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <header className="border-b border-gray-200 bg-primary text-white md:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          <div>
            <div className="text-sm font-semibold">Field Worker Portal</div>
            <div className="text-xs text-white/80">Task board</div>
          </div>
      ...
      <div className="flex flex-col md:flex-row">
        <aside className="hidden w-64 flex-col bg-primary text-white md:flex md:min-h-screen">
          <div className="border-b border-white/20 p-4 text-lg font-bold">Field Worker Portal</div>
